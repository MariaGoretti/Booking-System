...
<html lang="en">
  ...
  <head>
    ...
    <title>Finsmarts Consultancy System</title>
    	...
    	<header role="header" class="header-top" id="headere-top">
                    ...
                    <hgroup class="row">
                        ...
                        <div class="col-xs-5 col-sm-2 col-md-2 col-lg-2">
                            ...
                            <h1>
                                ...
                                <!--<a href="#headere-top" title="Rooky"><img src="images/index.png" alt="Rooky" title="Rooky"/></a>-->
                        ...
                        <nav role="navigation" class="col-xs-12 col-sm-10 col-md-10 col-lg-10 navbar navbar-default">
                            ...
                            <div id="navbar" class="navbar-collapse collapse">
                                ...
                                <ul class="nav navbar-nav">
                                    ...
                                    <li><a href="#section-five" title="Contact">Newsletter</a></li>

                                    <li><a href="#section-six" title="Join Us">Contact</a></li>
                                      <li><a href="login.php" title="Join Us">Login</a></li>
            ...
            <!-- banner Text -->
                 ...
                 <section class="text-center">
                    ...
                    <h2>Finsmarts Consultancy System</h2>
                    ...
                    <p>Working together to achieve more</p>
                     ...
                     <a  href="login.php" class="button-header">Login & Book Your Financial Consultancy Session Today!</a>
        	...
        	<figure>
            	...
            	<div class="parallax-window item tp-banner-container" data-parallax="scroll" data-image-src="images/lendee.png"></div>
            ...
            <section class="section-one text-center" id="section-one">
            	...
            	<div class="container">
                    ...
                    <article>
                    	...
                    	<p>Established in 2014, the FinSmarts team is highly valued for their finance skills in market research,
						project management and policy development.
						We offer consultants that are well experienced with whom a client can easily book an appointment. We ensure we equipe our clients with the skills and knowledge to better manage their finances and promote social inclusion.</p>
                    ...
                    <div id="owl-demo" class="owl-carousel text-center" role="slider">
                    	...
                    	<section class="item">
                            ...
                            <article>
                                ...
                                Book and follow up on your appointments without stress and hustle.
            	...
            	<div class="container">
                    ...
                    <div class="subscribe-form">
                        ...
                        <div class="ntify_form">
                            ...
                            <form method="post" action="newsletter.php" id="subscribeform">
            ...
            <section class="section-six" id="section-six">
            	...
            	<div class="container">
                	 ...
                	 <header role="title-page" class="text-center">
                        ...
                        <h2>Have any questions? Our team will happy to<br/>answer them.</h2>
                    ...
                    <div class="contact-form">
                        ...
                        <div id="message"></div>
								...
								<input type="hidden" name="new" value="1" />
                                	...
                                	<input  required name="name" id="name" type="text" placeholder="Full Name">
                                ...
                                <textarea required name="question" id="comments" cols="" rows="" placeholder="Question in Detail"></textarea>
...
$result=mysqli_query($conn, "insert into contact (`name`, `email`, `question`) values ('$name', '$email', '$question')");
 if ($result)
{
$status = "Your question has been received. We will get back to you.";
		...
		?>
           ...
           <footer role="footer" class="footer text-center">
                ...
                <br>
                    ...
                    <center><p class="copy">&copy; 2018<br>All rights reserved</p></center>
